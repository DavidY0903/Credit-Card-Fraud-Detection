...
def invoke_endpoint(payload):
    ...
    auth = BotoAWSRequestsAuth(aws_host="em7eygib2h.execute-api.{}.amazonaws.com".format(region),
                           aws_region=region,
                           aws_service='execute-api')

    invoke_url = "https://em7eygib2h.execute-api.{}.amazonaws.com/prod/invocations".format(region)
